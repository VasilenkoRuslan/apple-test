<?php $temp_site_dir = THEME_DIR_URI.'/junno/'; ?>
<!DOCTYPE html>
...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="<?= $temp_site_dir; ?>assets/img/favicon.ico" />
    ...
    *************************************-->
    ...
    <link rel="stylesheet" href="<?= $temp_site_dir; ?>assets/css/fontawesome.min.css" />
    <link rel="stylesheet" href="<?= $temp_site_dir; ?>assets/css/ionicons.min.css" />
    <link rel="stylesheet" href="<?= $temp_site_dir; ?>assets/css/simple-line-icons.css" />
    <link rel="stylesheet" href="<?= $temp_site_dir; ?>assets/css/plugins/jquery-ui.min.css">
    <link rel="stylesheet" href="<?= $temp_site_dir; ?>assets/css/bootstrap.min.css" />
    <link rel="stylesheet" href="<?= $temp_site_dir; ?>assets/css/plugins/plugins.css" />
    <link rel="stylesheet" href="<?= $temp_site_dir; ?>assets/css/style.min.css" />
    ...
    ****************************-->
     ...
     ***********************************************-->
    <!-- <link rel="stylesheet" href="<?= $temp_site_dir; ?>assets/css/vendor/vendor.min.css" />
    <link rel="stylesheet" href="<?= $temp_site_dir; ?>assets/css/plugins/plugins.min.css" />
    <link rel="stylesheet" href="<?= $temp_site_dir; ?>assets/css/style.min.css" /> -->
  <?php wp_head(); ?>
</head>
...
<div id="offcanvas-wishlist" class="offcanvas offcanvas-wishlist theme1">
    <div class="inner">
        ...
        <ul class="minicart-product-list">
            <li>
                <a href="single-product.html" class="image"><img src="<?= $temp_site_dir; ?>assets/img/product/4.jpg"
            ...
            <li>
                <a href="single-product.html" class="image"><img src="<?= $temp_site_dir; ?>assets/img/product/5.jpg"
                                                                 alt="Cart product Image"></a>
                <div class="content">
            ...
            <li>
                <a href="single-product.html" class="image"><img src="<?= $temp_site_dir; ?>assets/img/product/6.jpg"
                                                                 alt="Cart product Image"></a>
                <div class="content">
...
<div id="offcanvas-cart" class="offcanvas offcanvas-cart theme1">
    <div class="inner">
        ...
        <ul class="minicart-product-list">
            <li>
                <a href="single-product.html" class="image"><img src="<?= $temp_site_dir; ?>assets/img/product/1.jpg"
                                                                 alt="Cart product Image"></a>
                <div class="content">
                    <a href="single-product.html" class="title">Walnut Cutting Board</a>
                    <span class="quantity-price">1 x <span class="amount">$100.00</span></span>
            ...
            <li>
                <a href="single-product.html" class="image"><img src="<?= $temp_site_dir; ?>assets/img/product/2.jpg"
                                                                 alt="Cart product Image"></a>
                <div class="content">
                    <a href="single-product.html" class="title">Lucky Wooden Elephant</a>
                    <span class="quantity-price">1 x <span class="amount">$35.00</span></span>
            ...
            <li>
                <a href="single-product.html" class="image"><img src="<?= $temp_site_dir; ?>assets/img/product/3.jpg"
                                                                 alt="Cart product Image"></a>
                <div class="content">
                    <a href="single-product.html" class="title">Fish Cut Out Set</a>
                    <span class="quantity-price">1 x <span class="amount">$9.00</span></span>
                        ...
                        <ul class="d-flex justify-content-center justify-content-md-end align-items-center">
                            ...
                            <li class="english">
                                <a href="#" id="dropdown3" class="pr-0" data-toggle="dropdown" aria-haspopup="true"
                                   aria-expanded="false">
                                    <img src="<?= $temp_site_dir; ?>assets/img/logo/us-flag.jpg" alt="us flag"> English
                                    <i class="ion ion-ios-arrow-down"></i>
                                </a>
                                <ul class="topnav-submenu dropdown-menu" aria-labelledby="dropdown3">
                                    <li class="active">
                                        <a href="#"><img src="<?= $temp_site_dir; ?>assets/img/logo/us-flag.jpg" alt="us flag">
                                            English</a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="<?= $temp_site_dir; ?>assets/img/logo/france.jpg" alt="france flag">
                                            Français</a>
                                    </li>
                                </ul>
                            </li>
            ...
            <div class="row align-items-center">
                <div class="col-sm-6 col-lg-2 order-first">
                    <div class="logo text-center text-sm-left mb-30 mb-sm-0">
                        <a href="index.html"><img src="<?= $temp_site_dir; ?>assets/img/logo/logo-dark.jpg" alt="logo"></a>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-5 col-xl-4">
                    ...
                    <div class="d-flex align-items-center justify-content-center justify-content-sm-end">
                        <div class="media static-media mr-50 d-none d-lg-flex">
                            <img class="mr-3 align-self-center" src="<?= $temp_site_dir; ?>assets/img/icon/1.png" alt="icon">
                            ...
                            <ul class="mega-menu row">
                                ...
                                <li class="col-6 mt-4">
                                    <a href="single-product.html" class="zoom-in overflow-hidden"><img
                                                src="<?= $temp_site_dir; ?>assets/img/mega-menu/1.jpg" alt="img"></a>
                                </li>
                                <li class="col-6 mt-4">
                                    <a href="single-product.html" class="zoom-in overflow-hidden"><img
                                                src="<?= $temp_site_dir; ?>assets/img/mega-menu/2.jpg" alt="img"></a>
                                </li>
                            </ul>
                        </li>
                        <li>
        ...
        <div class="row">
            <div class="col-12">
                <div class="section-title text-center mb-15">
                    <h2 class="title text-dark text-capitalize">Blog grid 3 column</h2>
                </div>
            </div>
            <div class="col-12">
                <ol class="breadcrumb bg-transparent m-0 p-0 align-items-center justify-content-center">
                    <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Blog grid 3 column</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12 col-md-6 col-lg-4 col-xl-4 mb-30">
                <div class="single-blog text-left">
                    <a class="blog-thumb mb-20 zoom-in d-block overflow-hidden" href="blog-grid-left-sidebar.html">
                        <img src="<?= $temp_site_dir; ?>assets/img/blog-post/1.jpg" alt="blog-thumb-naile">
                    </a>
                    <div class="blog-post-content">
                        <h5 class="sub-title"> Posted by <a class="blog-link"
                            ...
                            27 sep, 2020 <span class="separator">/</span> <a class="blog-link"
                                                                             href="https://themeforest.net/user/hastech">Fashion</a></h5>
            ...
            <div class="col-12 col-md-6 col-lg-4 col-xl-4 mb-30">
                <div class="single-blog text-left">
                    <a class="blog-thumb mb-20 zoom-in d-block overflow-hidden" href="blog-grid-left-sidebar.html">
                        <img src="<?= $temp_site_dir; ?>assets/img/blog-post/2.jpg" alt="blog-thumb-naile">
                    </a>
                    <div class="blog-post-content">
                        <h5 class="sub-title"> Posted by <a class="blog-link"
                                                            href="https://themeforest.net/user/hastech">HasTech</a> <span class="separator">/</span>
            ...
            <div class="col-12 col-md-6 col-lg-4 col-xl-4 mb-30">
                <div class="single-blog text-left">
                    <a class="blog-thumb mb-20 zoom-in d-block overflow-hidden" href="blog-grid-left-sidebar.html">
                        <img src="<?= $temp_site_dir; ?>assets/img/blog-post/3.jpg" alt="blog-thumb-naile">
                    </a>
                    <div class="blog-post-content">
                        <h5 class="sub-title"> Posted by <a class="blog-link"
                                                            href="https://themeforest.net/user/hastech">HasTech</a> <span class="separator">/</span>
                ...
                <div class="col-12 col-md-6 col-lg-4 mb-30">
                    <div class="footer-widget mx-w-400">
                        <div class="footer-logo mb-35">
                            <a href="index.html">
                                <img src="<?= $temp_site_dir; ?>assets/img/logo/logo-dark.jpg" alt="footer logo">
                            </a>
                        </div>
                    ...
                    <div class="footer-widget">
                        ...
                        <div class="store d-flex">
                            <a href="https://www.apple.com/" class="d-inline-block mr-3"><img
                                        src="<?= $temp_site_dir; ?>assets/img/icon/apple.png" alt="apple icon"> </a>
                            <a href="https://play.google.com/store/" class="d-inline-block"><img
                                        src="<?= $temp_site_dir; ?>assets/img/icon/play.png" alt="apple icon"> </a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-8">
                    <div class="text-left">
                        <img src="<?= $temp_site_dir; ?>assets/img/payment/1.png" alt="img">
                    </div>
                </div>
            </div>
        </div>
...
<script src="<?= $temp_site_dir; ?>assets/js/vendor/jquery-3.5.1.min.js"></script>
<script src="<?= $temp_site_dir; ?>assets/js/vendor/modernizr-3.7.1.min.js"></script>
<script src="<?= $temp_site_dir; ?>assets/js/popper.min.js"></script>
<script src="<?= $temp_site_dir; ?>assets/js/plugins/jquery-ui.min.js"></script>
<script src="<?= $temp_site_dir; ?>assets/js/bootstrap.min.js"></script>
<script src="<?= $temp_site_dir; ?>assets/js/plugins/plugins.js"></script>
<script src="<?= $temp_site_dir; ?>assets/js/main.js"></script>
...
<!-- <script src="<?= $temp_site_dir; ?>assets/js/vendor/vendor.min.js"></script>
<script src="<?= $temp_site_dir; ?>assets/js/plugins/plugins.min.js"></script>
<script src="<?= $temp_site_dir; ?>assets/js/main.js"></script> -->
